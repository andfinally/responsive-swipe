...
?><div class="pageBodyInner">
    ...
    <div class="span12">
		...
		<p>The best way to familiarise yourself with the ins and outs of Responsive Swipe is to download the code for this demo site. If you're familiar with GitHub you'll know how to clone the repository. If you don't, find this button in the bottom right of the GitHub page, download the zip file with the site files, and extract to the root of a PHP-enabled server.</p>
		<img src="img/download-zip.png" class="centre actual" />
		<p>If you change the path of the site from /responsive-swipe-demo, update the <code>baseUrl</code> variable in <code>outer_page_bits.php</code>.</p>
...
var mySwipe = $('#pageBody').responsiveSwipe({
	...
	<span class="responsive-swipe-meta" data-pagedata="{&quot;title&quot;:&quot;Responsive Swipe - How it Works&quot;,&quot;environment&quot;:&quot;prod&quot;}"></span>
